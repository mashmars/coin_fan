	...
	<form class="form form-horizontal" action='' method='post'>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["title"]); ?>" placeholder="" id="articletitle" name="title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;" name='content'><?php echo (html_entity_decode($info["content"])); ?></script> 
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript" src="<?php echo (PUB_STATIC); ?>h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer /作为公共模版分离出去-->
...
<script type="text/javascript" src="<?php echo (PUB_LIB); ?>webuploader/0.1.5/webuploader.min.js"></script> 
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '<?php echo (PUB_LIB); ?>webuploader/0.1.5/Uploader.swf',
