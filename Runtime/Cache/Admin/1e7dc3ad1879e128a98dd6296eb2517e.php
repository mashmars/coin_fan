...
<div class="page-container">
	<p class="f-20 text-success">欢迎使用 <span class="f-14"></span>后台管理系统</p>
	
	
	 <table class="table table-border table-bordered table-bg mt-20">
		<thead>
			<tr>
				<th colspan="2" scope="col">统计信息</th>
			</tr>
		</thead>
		<tbody>			
			<tr>
				<td>当日转入总量</td>
				<td><?php echo ($data['zr']); ?></td>
			</tr>
			<tr>
				<td>当日转出总量</td>
				<td><?php echo ($data['zc']); ?></td>
			</tr>
			<tr>
				<td>平台总量</td>
			...
			<tr>
				<td>动态收益</td>
				<td><?php echo ($data['dynamic']); ?></td>
			</tr>
			<tr>
				<td>静态收益</td>
				<td><?php echo ($data['static']); ?></td>
			</tr>
			<tr>
				<td>扣费金额</td>
...
<footer class="footer mt-20">
	<div class="container">
		<p><br>
			Copyright &copy;2015-2017 All Rights Reserved.<br>
			本后台系统由<a href=""  title=""></a>提供技术支持</p>
	</div>
</footer>
