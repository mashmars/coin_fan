...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off"  placeholder="确认新密码" id="pwd2" name="pwd">
		</div>
	</div>
...
$(function(){
	$('#submit').click(function(){
		...
		$.ajax({
			url:"<?php echo U('auth/ajax_admin_add');?>",
			data:{username:username,pwd:pwd,pwd2:pwd2,group_id:group_id,descript:descript},
			type:"post",
			dataType:"json",
			success:function(data){
