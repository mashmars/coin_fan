...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">二手车鉴定评估师证书查询系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">鸡宝宝</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">1.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<!-- <li><a data-href="<?php echo U('system/banner');?>" data-title="首页banner" href="javascript:void(0)">首页banner</a></li> -->
