	...
	<div class="text-c" >
		...
		<span class="select-box inline">			
			<select name="status" id='' class="select">
				...
				<option value="" data-type='' <?php if($status == ''): ?>selected<?php endif; ?>>全部状态</option>
				<option value="0" data-type='input' <?php if($status == '0'): ?>selected<?php endif; ?>>未处理</option>
				<option value="1" data-type='input' <?php if($status == 1): ?>selected<?php endif; ?>>已处理</option>
				<option value="2" data-type='input' <?php if($status == 2): ?>selected<?php endif; ?>>已拒绝</option>
				</select>
		</span>
		<label>筛选查询：</label>
		<span class="select-box inline">			
			<select name="" id='field' class="select">
				...
				<option value="address" data-type='input' <?php if($field == 'address'): ?>selected<?php endif; ?>>转出地址</option>
				</select>
		</span>
