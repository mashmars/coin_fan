...
<html>
	...
	<script src="<?php echo (PUB_LIB); ?>echarts/echarts-all.js"></script>
				...
				series : [
					{
						...
						rootLocation: {x: 20,y: 230}, // 根节点位置  {x: 100, y: 'center'}
						nodePadding: 8,
						layerPadding: 200,
						hoverable: false,
						roam: true,
