...
<html>
	...
	<h3 class="tc lhbg">
		...
		<div class="main register">
				...
				<ul>
					<li><i class="icphone"></i><input type="text"placeholder="<?php echo L('phone');?>" id="phone"></li>
					<li class="flex-box">
						<i class="icodetxt"></i>
						<input type="text"placeholder="<?php echo L('sms');?>" id='sms'>
						<span class="flex-1 code"><?php echo L('sms_get');?></span>
					</li>
					<li><i class="icname"></i><input type="text"placeholder="<?php echo L('realname');?>" id='realname'></li>
					<li class="active">
						<i class="icpay"></i><input type="password" placeholder="<?php echo L('password_login');?>" id='password'>
						<!--<i class="hided"></i>-->
					</li>
					<li><i class="icpwd1"></i><input type="password"placeholder="<?php echo L('paypassword');?>" id='paypassword'></li>
					<li><i class="icrec"></i><input type="number" placeholder="<?php echo L('refer');?>" id='refer'></li>
				</ul>
				<div class="reg-box">
					<p class="tc"id="area">
						<span class="active" data-id='1'><i></i><?php echo L('zone1');?></span>
						<span  data-id='2'><i></i><?php echo L('zone2');?></span>
					</p>
					<p class="agreement"id="agree">
						<i class="active"></i>
						<span><?php echo L('agree');?></span>
						<a href="#" id='read'>《<?php echo L('xieyi');?>》</a>
					</p>
					<p class="tc reg-btn"><button class="lhbg mod-btn" id='register'><?php echo L('submit');?></button></p>
					<p class="tr logbtn"><a href="<?php echo U('login/password');?>"><?php echo L('login');?></a></p>
				</div>
...
$(function(){
	...
	$('#register').click(function(){
		...
		if(!agree){
			layer.msg("<?php echo L('agree');?>",{time:2000,icon:5});
		...
		if(refer == ''){
			layer.msg("<?php echo L('refer_set_empty');?>",{time:2000,icon:5});
			obj.prop('disabled',false);
			return false;
		}
