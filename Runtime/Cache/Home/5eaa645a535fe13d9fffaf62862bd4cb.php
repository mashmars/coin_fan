...
<html>
	...
	<title><?php echo L('submenu_2');?></title>
	...
	<script type="text/javascript">
		...
		var p = 2;
			...
			function pullDownAction () {
				setTimeout(function () { 
					var url = "<?php echo U('finance/ajax_myzrdetail');?>";
					$.ajax({
							url:url,
							type:'post',
							data:{
						...
						success:function(result){
							...
							$.each(result,function(k,v){
								...
								if(v.id){
									...
									list += '<div class="flex-1"><h4>'+"<?php echo L('menu_cb');?>"+'</h4><p><span>'+v.date+'</span><span>'+v.time+'</span></p></div></div>';
